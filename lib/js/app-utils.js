	...
	App.utils = {
		...
		loadMedia: function(url, autoplay) {
			...
			function onError(error) {
				//alert('[Media onError]: ' + error.code);
				//alert('[Media onError]: ' + error.message);
				console.log('[Media onError]: ' + error.code);
				console.log('[Media onError]: ' + error.message);
				//disable player and UI
				if (App.view.AudioPlayer) {
					App.view.AudioPlayer.stop();
			...
			function onStatus(status) {
				//alert('[Media onStatus]: ' + status);
				console.log('[Media onStatus]: ' + status);
				//updateMediaStatus
				App.view.updateMediaStatus(status);
			}
