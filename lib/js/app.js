...
window.App = (function(app){
	...
	App.onDeviceReady = function(e) {
		...
		*/
		...
		if (window.Platform.iOS) testURL = '../Library/HydraApps/0/data/';
		if (window.Platform.android) testURL = 'file:///data/data/com.fraynework.lectiodivina2013/hydra_app/data/';
		
		my_media = new Media(testURL + 'test.mp3', onSuccess, onError);
		//alert(my_media);
		my_media.play();
