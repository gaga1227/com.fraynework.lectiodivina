	...
	App.view = {
		...
		initScroller: function(){
			...
			if (typeof(IScroll) == 'function') {
				...
				//events
				App.view.Scroller.on('beforeScrollStart', 	function(){ window.scrolling = true; });
				App.view.Scroller.on('scrollStart', 		function(){  }); 
				App.view.Scroller.on('scrollEnd', 			function(){ window.scrolling = false; });
		...
		initArticleScroller: function( $article ){
			...
			if (typeof(IScroll) == 'function') {
				...
				//events
				App.view.articleScroller.on('beforeScrollStart', 	function(){ window.articleScrolling = true; });
				App.view.articleScroller.on('scrollStart', 			function(){  }); 
				App.view.articleScroller.on('scrollEnd', 			function(){ window.articleScrolling = false; });
			}
		},
