...
window.App = (function(app){
	...
	App.view = {
		...
		onSegmentdidchange: function(e){
			//vars
			var weeksScroller = this.weeksScroller,
		...
		initPage: function( $page ){
			...
			//weeks
				...
				(function(){
					//vars
					var weeksScroller = App.view.weeksScroller,
						$navTabs = $('#nav'),
						$btnTabs = $navTabs.find(App.view.selectors.btnNavWeek),
						currentCLS = 'current',
						params = App.utils.getVarsFromSearch();
					//weeksScroller events
					weeksScroller.addEventListener('segmentdidchange', App.view.onSegmentdidchange);
					...
					$btnTabs.on('tap', function(e){
						...
						//trigger scrolling
						weeksScroller.scrollTo(offsetLeft, 0, true);
